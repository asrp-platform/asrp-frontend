...
interface IProps {
    initialValues?: IUserFellowshipFormValues
    onSubmit: (_values: IUserFellowshipFormValues) => Promise<void>
...
const emptyValues: IUserFellowshipFormValues = {
    institution: "",
    speciality: "",
    city: "",
    state: "",
...
const FellowshipForm = ({ initialValues, onSubmit, onDelete, startInEditMode = false }: IProps) => {
    const [form] = Form.useForm<IUserFellowshipFormValues>()
    ...
    const handleFinish = async (values: IUserFellowshipFormValues) => {
        try {
            setIsLoading(true)
    ...
    return (
        <div className={styles.residencyFormContainer}>
            ...
            >
                <p>
                    This action cannot be undone. Are you sure you want to delete this fellowship?
                </p>
            </Modal>
        </div>
    )
