...
export const metadata: Metadata = {
    ...
    description: "Professional community for Russian-speaking pathologists in the United States.: education, mentorship, networking, and CME-oriented initiatives.",
            ...
            <section>
                <div className={styles.memberOutcomesContainer}>
                    <div className={styles.memberOutcomesInfoContainer}>
                        ...
                        <p>
                            Whether you are stepping into training, advancing subspecialty skills,
                            or leading a laboratory, ASRP programs provide the structure and
                            community to thrive.
                        </p>
                    </div>
                    <div className={styles.memberOutcomesCardContainer}>
                        <div className={styles.memberOutecomesCard}>
