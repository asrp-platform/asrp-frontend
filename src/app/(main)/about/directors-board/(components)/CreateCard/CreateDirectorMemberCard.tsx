...
import { DIRECTORS_BOARD_ADMIN_URL } from "@shared/backend/restApiUrls/admin/adminApiUrls.ts"
...
const CreateDirectorMemberCard = () => {
    ...
    return (
        <div className={styles.createCardActive}>
            ...
            >
                <Form.Item name="role" rules={[{ required: true, message: "Please enter role" }]}>
                    <Input className={styles.roleInput} placeholder="Enter role..." />
                </Form.Item>

                <Form.Item name="name" rules={[{ required: true, message: "Please enter name" }]}>
                    <Input className={styles.nameInput} placeholder="Enter name..." />
                </Form.Item>
                ...
                <div className={styles.buttonContainer}>
                    ...
                    <Button htmlType="button" onClick={handleReset} danger>
                        Reset
                    </Button>
                </div>
