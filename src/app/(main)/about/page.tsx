                ...
                <div className={styles.sectionContainer}>
                    <div className={styles.missionContainer}>
                        <div className={styles.missionInfoContainer}>
                            <h2>Our Mission</h2>
                            <p>ASRP strives to build a dynamic, welcoming, and academically rich community for Russian-speaking pathologists, trainees, and pathology aspirants across the United States. Through mentorship, scientific collaboration, and educational events, we aim to promote professional growth and integration within the broader pathology community.</p>
                            <p>We envision ASRP as a platform that connects members through shared values, mutual respect, and commitment to advancing pathology as a discipline.</p>
                        </div>
                        <div className={styles.initiativesContainer}>
                            <h3>Key initiatives</h3>
                            <ul>
                                <li>Unite most Russian-speaking pathologists across the United States</li>
                    ...
                    <div className={styles.linksContainer}>
                        <h2>Quick Links</h2>
                        {/* TODO: ссылка */}
                        <Link className={styles.byLawsLink} href="#">📄 View Our Bylaws</Link>
