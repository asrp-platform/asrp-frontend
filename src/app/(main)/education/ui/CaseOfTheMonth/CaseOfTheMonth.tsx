        ...
        <div className={styles.caseOfMonthSection}>
            ...
            <div className={styles.caseOfMonthCard}>
                <p>
                    ...
                    contributed by practicing pathologists, residents, and fellows from across the
                    Russian-speaking and international pathology community. Each monthly case
                    showcases key diagnostic features, practical workup approaches, differential
                    diagnoses, and relevant ancillary studies—supported by high-quality digital
                    images.
                </p>
                <p>
                    The series promotes active learning across all subspecialties, including
                    surgical pathology, cytopathology, hematopathology, molecular diagnostics, and
                    laboratory medicine. It is useful for trainees preparing for board examinations
                    and for practicing pathologists who want to refresh or expand their diagnostic
                    skills.
                </p>
