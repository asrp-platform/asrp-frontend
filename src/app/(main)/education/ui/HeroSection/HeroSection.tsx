        ...
        <div className={styles.heroContainer}>
            <div className={styles.heroContent}>
                ...
                <p className={styles.heroDescription}>
                    ...
                    pathologists, trainees, and laboratory professionals in the United States and
                    worldwide. Our mission is to promote excellence in pathology through accessible,
                    high-quality educational resources that bridge language, culture, and scientific
                    expertise.
                </p>
                <p className={styles.heroDescription}>
                    ...
                    journal clubs, and board-exam preparation resources. Materials are curated and
                    reviewed by experienced academic and clinical pathologists to ensure accuracy,
                    relevance, and alignment with current U.S. standards of practice.
                </p>
                <p className={styles.heroDescription}>
                    ...
                    members integrate into American healthcare systems while maintaining strong ties
                    to the international pathology community.
                </p>
