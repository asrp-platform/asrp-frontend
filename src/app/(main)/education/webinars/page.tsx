...
import { ArrowRight, CalendarDays, Clock3, LockKeyhole, MapPin, Play } from "lucide-react"
...
const recordings = [
    {
        ...
        title: "A Practical Approach to Lymph Node Biopsies",
        speaker: "Dr. Anna Petrova",
        duration: "58 min",
    },
    {
        category: "Career development",
        title: "Navigating the U.S. Pathology Job Market",
        speaker: "ASRP Career Panel",
        duration: "64 min",
    },
    {
        category: "Surgical pathology",
        title: "Common Pitfalls in Gastrointestinal Pathology",
        speaker: "Dr. Michael Levin",
        duration: "52 min",
    },
]
...
const Page = () => {
    return (
        <div className={styles.pageContainer}>
                ...
                <article className={styles.featuredCard}>
                    ...
                    <div className={styles.featuredContent}>
                        ...
                        <p className={styles.summary}>
                            Review a practical, pattern-based approach to challenging soft tissue
                            tumors. This interactive session will highlight common diagnostic
                            pitfalls and the role of ancillary studies in everyday practice.
                        </p>
            ...
            <PageSection className={styles.archiveSection}>
                <div className={styles.sectionHeader}>
                    <div>
                        <h2>Past webinars</h2>
                        <p>
                            Browse previous ASRP educational programs and access available
                            recordings.
                        </p>
                    </div>
                    <Link href="/membership/become-member" className={styles.archiveLink}>
                ...
                <div className={styles.recordingGrid}>
                    {recordings.map((recording, index) => (
                        <article className={styles.recordingCard} key={recording.title}>
                            <div
                                className={`${styles.recordingVisual} ${styles[`visual${index + 1}`]}`}
                            >
                            ...
                            <div className={styles.recordingContent}>
                                ...
                                <div>
                                    <LockKeyhole size={14} /> Members only
                                </div>
                            </div>
                        </article>
                    ))}
